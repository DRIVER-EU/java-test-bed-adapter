...
public class Polygon extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 5036739070099763832L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Polygon\",\"namespace\":\"eu.driver.model.geojson.sim\",\"doc\":\"Describes a Polygon geometry\",\"fields\":[{\"name\":\"type\",\"type\":{\"type\":\"enum\",\"name\":\"PolygonType\",\"symbols\":[\"Polygon\"]},\"default\":\"Polygon\"},{\"name\":\"coordinates\",\"type\":{\"type\":\"array\",\"items\":{\"type\":\"array\",\"items\":{\"type\":\"array\",\"items\":\"double\"}}}}]}");
  ...
  @Deprecated public eu.driver.model.geojson.sim.PolygonType type;
   ...
   */
  public Polygon(eu.driver.model.geojson.sim.PolygonType type, java.util.List<java.util.List<java.util.List<java.lang.Double>>> coordinates) {
    this.type = type;
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: type = (eu.driver.model.geojson.sim.PolygonType)value$; break;
   ...
   */
  public eu.driver.model.geojson.sim.PolygonType getType() {
    return type;
  }
   ...
   */
  public void setType(eu.driver.model.geojson.sim.PolygonType value) {
    this.type = value;
  }
   ...
   */
  public static eu.driver.model.geojson.sim.Polygon.Builder newBuilder() {
    return new eu.driver.model.geojson.sim.Polygon.Builder();
  }
   ...
   * @return A new Polygon RecordBuilder
   */
  public static eu.driver.model.geojson.sim.Polygon.Builder newBuilder(eu.driver.model.geojson.sim.Polygon.Builder other) {
    return new eu.driver.model.geojson.sim.Polygon.Builder(other);
  }
   ...
   * @return A new Polygon RecordBuilder
   */
  public static eu.driver.model.geojson.sim.Polygon.Builder newBuilder(eu.driver.model.geojson.sim.Polygon other) {
    return new eu.driver.model.geojson.sim.Polygon.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Polygon>
    ...
    private eu.driver.model.geojson.sim.PolygonType type;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(eu.driver.model.geojson.sim.Polygon.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(eu.driver.model.geojson.sim.Polygon other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.type)) {
        this.type = data().deepCopy(fields()[0].schema(), other.type);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public eu.driver.model.geojson.sim.Polygon.Builder setType(eu.driver.model.geojson.sim.PolygonType value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public eu.driver.model.geojson.sim.Polygon.Builder clearType() {
      type = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public eu.driver.model.geojson.sim.Polygon.Builder setCoordinates(java.util.List<java.util.List<java.util.List<java.lang.Double>>> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public eu.driver.model.geojson.sim.Polygon.Builder clearCoordinates() {
      coordinates = null;
    ...
    public Polygon build() {
      try {
        ...
        record.type = fieldSetFlags()[0] ? this.type : (eu.driver.model.geojson.sim.PolygonType) defaultValue(fields()[0]);
