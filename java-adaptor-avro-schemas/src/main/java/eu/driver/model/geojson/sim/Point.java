...
public class Point extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 5118160066781932112L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Point\",\"namespace\":\"eu.driver.model.geojson.sim\",\"doc\":\"Describes a point geometry\",\"fields\":[{\"name\":\"type\",\"type\":{\"type\":\"enum\",\"name\":\"PointType\",\"symbols\":[\"Point\"]},\"default\":\"Point\"},{\"name\":\"coordinates\",\"type\":{\"type\":\"array\",\"items\":\"double\"}}]}");
  ...
  @Deprecated public eu.driver.model.geojson.sim.PointType type;
   ...
   */
  public Point(eu.driver.model.geojson.sim.PointType type, java.util.List<java.lang.Double> coordinates) {
    this.type = type;
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: type = (eu.driver.model.geojson.sim.PointType)value$; break;
   ...
   */
  public eu.driver.model.geojson.sim.PointType getType() {
    return type;
  }
   ...
   */
  public void setType(eu.driver.model.geojson.sim.PointType value) {
    this.type = value;
  }
   ...
   */
  public static eu.driver.model.geojson.sim.Point.Builder newBuilder() {
    return new eu.driver.model.geojson.sim.Point.Builder();
  }
   ...
   * @return A new Point RecordBuilder
   */
  public static eu.driver.model.geojson.sim.Point.Builder newBuilder(eu.driver.model.geojson.sim.Point.Builder other) {
    return new eu.driver.model.geojson.sim.Point.Builder(other);
  }
   ...
   * @return A new Point RecordBuilder
   */
  public static eu.driver.model.geojson.sim.Point.Builder newBuilder(eu.driver.model.geojson.sim.Point other) {
    return new eu.driver.model.geojson.sim.Point.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Point>
    ...
    private eu.driver.model.geojson.sim.PointType type;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(eu.driver.model.geojson.sim.Point.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(eu.driver.model.geojson.sim.Point other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.type)) {
        this.type = data().deepCopy(fields()[0].schema(), other.type);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public eu.driver.model.geojson.sim.Point.Builder setType(eu.driver.model.geojson.sim.PointType value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public eu.driver.model.geojson.sim.Point.Builder clearType() {
      type = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public eu.driver.model.geojson.sim.Point.Builder setCoordinates(java.util.List<java.lang.Double> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public eu.driver.model.geojson.sim.Point.Builder clearCoordinates() {
      coordinates = null;
    ...
    public Point build() {
      try {
        ...
        record.type = fieldSetFlags()[0] ? this.type : (eu.driver.model.geojson.sim.PointType) defaultValue(fields()[0]);
