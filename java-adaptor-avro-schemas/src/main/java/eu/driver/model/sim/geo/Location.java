...
public class Location extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static eu.driver.model.sim.geo.Location.Builder newBuilder() {
    return new eu.driver.model.sim.geo.Location.Builder();
  }
   ...
   * @return A new Location RecordBuilder
   */
  public static eu.driver.model.sim.geo.Location.Builder newBuilder(eu.driver.model.sim.geo.Location.Builder other) {
    return new eu.driver.model.sim.geo.Location.Builder(other);
  }
   ...
   * @return A new Location RecordBuilder
   */
  public static eu.driver.model.sim.geo.Location.Builder newBuilder(eu.driver.model.sim.geo.Location other) {
    return new eu.driver.model.sim.geo.Location.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Location>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(eu.driver.model.sim.geo.Location.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(eu.driver.model.sim.geo.Location other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.latitude)) {
        this.latitude = data().deepCopy(fields()[0].schema(), other.latitude);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public eu.driver.model.sim.geo.Location.Builder setLatitude(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public eu.driver.model.sim.geo.Location.Builder setLongitude(double value) {
