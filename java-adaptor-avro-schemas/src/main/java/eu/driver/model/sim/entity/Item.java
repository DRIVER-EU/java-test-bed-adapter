...
public class Item extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 4: orientation = (eu.driver.model.sim.geo.Orientation)value$; break;
    case 5: velocity = (eu.driver.model.sim.geo.Velocity)value$; break;
   ...
   */
  public static eu.driver.model.sim.entity.Item.Builder newBuilder() {
    return new eu.driver.model.sim.entity.Item.Builder();
  }
   ...
   * @return A new Item RecordBuilder
   */
  public static eu.driver.model.sim.entity.Item.Builder newBuilder(eu.driver.model.sim.entity.Item.Builder other) {
    return new eu.driver.model.sim.entity.Item.Builder(other);
  }
   ...
   * @return A new Item RecordBuilder
   */
  public static eu.driver.model.sim.entity.Item.Builder newBuilder(eu.driver.model.sim.entity.Item other) {
    return new eu.driver.model.sim.entity.Item.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Item>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(eu.driver.model.sim.entity.Item.Builder other) {
      super(other);
      ...
      if (other.hasOrientationBuilder()) {
        this.orientationBuilder = eu.driver.model.sim.geo.Orientation.newBuilder(other.getOrientationBuilder());
      }
      ...
      if (other.hasVelocityBuilder()) {
        this.velocityBuilder = eu.driver.model.sim.geo.Velocity.newBuilder(other.getVelocityBuilder());
      }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(eu.driver.model.sim.entity.Item other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.guid)) {
        this.guid = data().deepCopy(fields()[0].schema(), other.guid);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public eu.driver.model.sim.entity.Item.Builder setGuid(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public eu.driver.model.sim.entity.Item.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public eu.driver.model.sim.entity.Item.Builder setOwner(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public eu.driver.model.sim.entity.Item.Builder setLocation(eu.driver.model.sim.geo.Location value) {
     ...
     * @return This builder.
     */
    public eu.driver.model.sim.entity.Item.Builder setLocationBuilder(eu.driver.model.sim.geo.Location.Builder value) {
      clearLocation();
    ...
    /**
      ...
      * @return This builder.
      */
    public eu.driver.model.sim.entity.Item.Builder setOrientation(eu.driver.model.sim.geo.Orientation value) {
    ...
    public eu.driver.model.sim.geo.Orientation.Builder getOrientationBuilder() {
      if (orientationBuilder == null) {
        if (hasOrientation()) {
          setOrientationBuilder(eu.driver.model.sim.geo.Orientation.newBuilder(orientation));
        } else {
          setOrientationBuilder(eu.driver.model.sim.geo.Orientation.newBuilder());
        }
      }
     ...
     * @return This builder.
     */
    public eu.driver.model.sim.entity.Item.Builder setOrientationBuilder(eu.driver.model.sim.geo.Orientation.Builder value) {
      clearOrientation();
    ...
    /**
      ...
      * @return This builder.
      */
    public eu.driver.model.sim.entity.Item.Builder setVelocity(eu.driver.model.sim.geo.Velocity value) {
    ...
    public eu.driver.model.sim.geo.Velocity.Builder getVelocityBuilder() {
      if (velocityBuilder == null) {
        if (hasVelocity()) {
          setVelocityBuilder(eu.driver.model.sim.geo.Velocity.newBuilder(velocity));
        } else {
          setVelocityBuilder(eu.driver.model.sim.geo.Velocity.newBuilder());
        }
      }
     ...
     * @return This builder.
     */
    public eu.driver.model.sim.entity.Item.Builder setVelocityBuilder(eu.driver.model.sim.geo.Velocity.Builder value) {
      clearVelocity();
    ...
    /**
      ...
      * @return This builder.
      */
    public eu.driver.model.sim.entity.Item.Builder setVisibleForParticipant(boolean value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public eu.driver.model.sim.entity.Item.Builder setMovable(boolean value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public eu.driver.model.sim.entity.Item.Builder setItemType(java.lang.Object value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public eu.driver.model.sim.entity.Item.Builder setScenarioLabel(java.lang.Object value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public eu.driver.model.sim.entity.Item.Builder setUserTags(java.util.List<java.lang.CharSequence> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public eu.driver.model.sim.entity.Item.Builder setPhysicalConnections(java.util.List<java.lang.CharSequence> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public eu.driver.model.sim.entity.Item.Builder setGroup(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public eu.driver.model.sim.entity.Item.Builder setFormation(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public eu.driver.model.sim.entity.Item.Builder setUnit(java.lang.CharSequence value) {
    ...
    public Item build() {
      try {
        ...
        if (orientationBuilder != null) {
          ...
          record.orientation = fieldSetFlags()[4] ? this.orientation : (eu.driver.model.sim.geo.Orientation) defaultValue(fields()[4]);
        }
        if (velocityBuilder != null) {
          record.velocity = this.velocityBuilder.build();
        } else {
          record.velocity = fieldSetFlags()[5] ? this.velocity : (eu.driver.model.sim.geo.Velocity) defaultValue(fields()[5]);
        }
