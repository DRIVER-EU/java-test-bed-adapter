...
public class CISAdapterCAPExample {
	...
	public static void main(String[] args) throws InterruptedException, IOException {
		...
		adapter.addAvroReceiver("cap", new IAvroReceiver<GenericRecord>() {
			@Override
		...
		// Use the producer to send a CAP message. This will be received and printed via the Callback above.
