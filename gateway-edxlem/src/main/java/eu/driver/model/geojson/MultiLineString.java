...
public class MultiLineString extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 8793503188932359260L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"MultiLineString\",\"namespace\":\"eu.driver.model.geojson\",\"doc\":\"Describes a MultiLineString geometry\",\"fields\":[{\"name\":\"type\",\"type\":{\"type\":\"enum\",\"name\":\"MultiLineStringType\",\"symbols\":[\"MultiLineString\"]},\"default\":\"MultiLineString\"},{\"name\":\"coordinates\",\"type\":{\"type\":\"array\",\"items\":{\"type\":\"array\",\"items\":{\"type\":\"array\",\"items\":\"double\"}}}}]}");
  ...
  @Deprecated public eu.driver.model.geojson.MultiLineStringType type;
   ...
   */
  public MultiLineString(eu.driver.model.geojson.MultiLineStringType type, java.util.List<java.util.List<java.util.List<java.lang.Double>>> coordinates) {
    this.type = type;
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: type = (eu.driver.model.geojson.MultiLineStringType)value$; break;
   ...
   */
  public eu.driver.model.geojson.MultiLineStringType getType() {
    return type;
  }
   ...
   */
  public void setType(eu.driver.model.geojson.MultiLineStringType value) {
    this.type = value;
  }
   ...
   */
  public static eu.driver.model.geojson.MultiLineString.Builder newBuilder() {
    return new eu.driver.model.geojson.MultiLineString.Builder();
  }
   ...
   * @return A new MultiLineString RecordBuilder
   */
  public static eu.driver.model.geojson.MultiLineString.Builder newBuilder(eu.driver.model.geojson.MultiLineString.Builder other) {
    return new eu.driver.model.geojson.MultiLineString.Builder(other);
  }
   ...
   * @return A new MultiLineString RecordBuilder
   */
  public static eu.driver.model.geojson.MultiLineString.Builder newBuilder(eu.driver.model.geojson.MultiLineString other) {
    return new eu.driver.model.geojson.MultiLineString.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<MultiLineString>
    ...
    private eu.driver.model.geojson.MultiLineStringType type;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(eu.driver.model.geojson.MultiLineString.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(eu.driver.model.geojson.MultiLineString other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.type)) {
        this.type = data().deepCopy(fields()[0].schema(), other.type);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public eu.driver.model.geojson.MultiLineString.Builder setType(eu.driver.model.geojson.MultiLineStringType value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public eu.driver.model.geojson.MultiLineString.Builder clearType() {
      type = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public eu.driver.model.geojson.MultiLineString.Builder setCoordinates(java.util.List<java.util.List<java.util.List<java.lang.Double>>> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public eu.driver.model.geojson.MultiLineString.Builder clearCoordinates() {
      coordinates = null;
    ...
    public MultiLineString build() {
      try {
        ...
        record.type = fieldSetFlags()[0] ? this.type : (eu.driver.model.geojson.MultiLineStringType) defaultValue(fields()[0]);
