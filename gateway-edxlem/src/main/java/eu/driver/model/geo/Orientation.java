...
public class Orientation extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static eu.driver.model.geo.Orientation.Builder newBuilder() {
    return new eu.driver.model.geo.Orientation.Builder();
  }
   ...
   * @return A new Orientation RecordBuilder
   */
  public static eu.driver.model.geo.Orientation.Builder newBuilder(eu.driver.model.geo.Orientation.Builder other) {
    return new eu.driver.model.geo.Orientation.Builder(other);
  }
   ...
   * @return A new Orientation RecordBuilder
   */
  public static eu.driver.model.geo.Orientation.Builder newBuilder(eu.driver.model.geo.Orientation other) {
    return new eu.driver.model.geo.Orientation.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Orientation>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(eu.driver.model.geo.Orientation.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(eu.driver.model.geo.Orientation other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.yaw)) {
        this.yaw = data().deepCopy(fields()[0].schema(), other.yaw);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public eu.driver.model.geo.Orientation.Builder setYaw(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public eu.driver.model.geo.Orientation.Builder clearYaw() {
    ...
    /**
      ...
      * @return This builder.
      */
    public eu.driver.model.geo.Orientation.Builder setPitch(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public eu.driver.model.geo.Orientation.Builder clearPitch() {
    ...
    /**
      ...
      * @return This builder.
      */
    public eu.driver.model.geo.Orientation.Builder setRoll(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public eu.driver.model.geo.Orientation.Builder clearRoll() {
