...
public class Velocity extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static eu.driver.model.geo.Velocity.Builder newBuilder() {
    return new eu.driver.model.geo.Velocity.Builder();
  }
   ...
   * @return A new Velocity RecordBuilder
   */
  public static eu.driver.model.geo.Velocity.Builder newBuilder(eu.driver.model.geo.Velocity.Builder other) {
    return new eu.driver.model.geo.Velocity.Builder(other);
  }
   ...
   * @return A new Velocity RecordBuilder
   */
  public static eu.driver.model.geo.Velocity.Builder newBuilder(eu.driver.model.geo.Velocity other) {
    return new eu.driver.model.geo.Velocity.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Velocity>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(eu.driver.model.geo.Velocity.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(eu.driver.model.geo.Velocity other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.yaw)) {
        this.yaw = data().deepCopy(fields()[0].schema(), other.yaw);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public eu.driver.model.geo.Velocity.Builder setYaw(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public eu.driver.model.geo.Velocity.Builder clearYaw() {
    ...
    /**
      ...
      * @return This builder.
      */
    public eu.driver.model.geo.Velocity.Builder setPitch(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public eu.driver.model.geo.Velocity.Builder clearPitch() {
    ...
    /**
      ...
      * @return This builder.
      */
    public eu.driver.model.geo.Velocity.Builder setMagnitude(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public eu.driver.model.geo.Velocity.Builder clearMagnitude() {
