...
public class RescueLabel extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -262765574931362994L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"RescueLabel\",\"namespace\":\"com.xvrsim.model.entity.item\",\"doc\":\"information if the item is labeled as rescue\",\"fields\":[{\"name\":\"subLabel\",\"type\":{\"type\":\"enum\",\"name\":\"RescueSubLabel\",\"symbols\":[\"POLICE\",\"MEDICAL\",\"FIRE\",\"SECURITY\",\"MILITARY\"]},\"doc\":\"sub label of rescue that this item has\"}]}");
  ...
  @Deprecated public com.xvrsim.model.entity.item.RescueSubLabel subLabel;
   ...
   */
  public RescueLabel(com.xvrsim.model.entity.item.RescueSubLabel subLabel) {
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: subLabel = (com.xvrsim.model.entity.item.RescueSubLabel)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public com.xvrsim.model.entity.item.RescueSubLabel getSubLabel() {
    return subLabel;
  }
   ...
   */
  public void setSubLabel(com.xvrsim.model.entity.item.RescueSubLabel value) {
    this.subLabel = value;
  }
   ...
   */
  public static com.xvrsim.model.entity.item.RescueLabel.Builder newBuilder() {
    return new com.xvrsim.model.entity.item.RescueLabel.Builder();
  }
   ...
   * @return A new RescueLabel RecordBuilder
   */
  public static com.xvrsim.model.entity.item.RescueLabel.Builder newBuilder(com.xvrsim.model.entity.item.RescueLabel.Builder other) {
    return new com.xvrsim.model.entity.item.RescueLabel.Builder(other);
  }
   ...
   * @return A new RescueLabel RecordBuilder
   */
  public static com.xvrsim.model.entity.item.RescueLabel.Builder newBuilder(com.xvrsim.model.entity.item.RescueLabel other) {
    return new com.xvrsim.model.entity.item.RescueLabel.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<RescueLabel>
    ...
    /** sub label of rescue that this item has */
    private com.xvrsim.model.entity.item.RescueSubLabel subLabel;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.xvrsim.model.entity.item.RescueLabel.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.xvrsim.model.entity.item.RescueLabel other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.subLabel)) {
        this.subLabel = data().deepCopy(fields()[0].schema(), other.subLabel);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.xvrsim.model.entity.item.RescueLabel.Builder setSubLabel(com.xvrsim.model.entity.item.RescueSubLabel value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.xvrsim.model.entity.item.RescueLabel.Builder clearSubLabel() {
      subLabel = null;
    ...
    public RescueLabel build() {
      try {
        ...
        record.subLabel = fieldSetFlags()[0] ? this.subLabel : (com.xvrsim.model.entity.item.RescueSubLabel) defaultValue(fields()[0]);
        return record;
